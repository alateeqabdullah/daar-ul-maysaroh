...
const METHODOLOGY_STEPS = [
  {
    ...
    description:
      "Begin your journey with a personalized evaluation by our Dean of Academic Affairs.",
    icon: Crown,
    duration: "30-45 min",
  ...
  },
  {
    ...
    description:
      "Matched with an Ijazah-certified scholar who resonates with your learning style.",
    icon: Users,
  ...
  },
  {
    ...
    description:
      "Follow a structured curriculum designed for optimal retention and mastery.",
    icon: Layers,
    duration: "Ongoing",
  ...
  },
  {
    ...
    description:
      "Engage in live, real-time sessions with your dedicated scholar.",
    icon: Mic,
  ...
  },
  {
    ...
    description:
      "Reinforce learning with structured practice between sessions.",
    icon: Repeat,
...
const TECHNOLOGY_FEATURES = [
  {
    ...
    description: "All-in-one learning dashboard",
    badge: "Available",
  },
  {
    icon: HeadphonesIcon,
    title: "Audio Analysis",
    description: "Visual feedback on recitation",
    badge: "AI-Powered",
  },
  {
    icon: Smartphone,
    title: "Mobile App",
    description: "Practice on the go",
    badge: "Coming Soon",
  },
  {
    icon: BarChart3,
  ...
  },
  {
    ...
    description: "Review past lessons",
    badge: "Cloud Storage",
  },
  {
    icon: Database,
    title: "Resource Library",
    description: "Access thousands of materials",
    badge: "24/7",
  },
];
...
const structuredData = {
  ...
  description:
    "A revolutionary approach to Quran learning that honors 1,400 years of scholarly tradition while embracing modern learning science.",
  educationalProgram: {
...
export default function MethodologyClient() {
  ...
  return (
    <>
      {/* JSON-LD Structured Data - Only render on client */}
      {mounted && (
        <script
        ...
        <div className="container mx-auto px-4 xs:px-5 sm:px-6">
          ...
          <div className="text-center max-w-4xl mx-auto mb-10 xs:mb-12 sm:mb-16 md:mb-20">
            <Reveal>
              ...
              <p className="text-sm xs:text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto px-4">
                A revolutionary approach that honors 1,400 years of scholarly
                tradition while embracing cutting-edge learning science.
              </p>
            </Reveal>
          </div>
              ...
              return (
                <Reveal key={idx} delay={idx * 0.1}>
                  <div className="text-center p-2 xs:p-3 sm:p-4 rounded-xl bg-card border border-purple-200 dark:border-purple-800">
                    <Icon
                      className={`w-4 h-4 xs:w-5 xs:h-5 ${colors.text} mx-auto mb-1 xs:mb-2`}
                    />
                    <div
                    ...
                    <div className="text-[7px] xs:text-[8px] sm:text-[9px] md:text-[10px] font-black uppercase tracking-wider text-muted-foreground">
                      {stat.label}
                    </div>
                  </div>
                </Reveal>
            ...
            <div className="bg-card rounded-xl xs:rounded-2xl border border-purple-200 dark:border-purple-800 p-4 xs:p-5 sm:p-6 md:p-8 mb-12 xs:mb-16 sm:mb-20">
              <div className="text-center mb-4 xs:mb-5 sm:mb-6 md:mb-8">
                ...
                <p className="text-xs xs:text-sm sm:text-base text-muted-foreground">
                  An unbroken lineage of light spanning 1,400 years
                </p>
              </div>
                  ...
                  return (
                    <div key={idx} className="flex items-center">
                      <div className="text-center">
                        <div
                          className={`w-8 h-8 xs:w-10 xs:h-10 sm:w-12 sm:h-12 rounded-full ${colors.bg} border ${colors.border} flex items-center justify-center mx-auto mb-0.5 xs:mb-1 sm:mb-2`}
                        >
                          <Icon
                            className={`w-3.5 h-3.5 xs:w-4 xs:h-4 sm:w-5 sm:h-5 ${colors.text}`}
                          />
                        </div>
                        <span className="text-[7px] xs:text-[8px] sm:text-[9px] md:text-[10px] font-black whitespace-nowrap">
                          {node.name}
                        </span>
                      </div>
          ...
          <div className="mb-12 xs:mb-16 sm:mb-20">
            <div className="text-center mb-6 xs:mb-8 sm:mb-12">
              ...
              <p className="text-xs xs:text-sm sm:text-base text-muted-foreground">
                Six transformative phases to mastery
              </p>
            </div>
                    ...
                    <div className="bg-card rounded-xl border border-purple-200 dark:border-purple-800 hover:border-purple-300 transition-all overflow-hidden h-full flex flex-col group">
                      <div className="p-4 xs:p-5 sm:p-6 flex-1">
                        <div className="flex items-center gap-2 xs:gap-3 mb-3 xs:mb-4">
                          ...
                          <div>
                            <span className="text-[7px] xs:text-[8px] sm:text-[9px] font-black text-purple-600">
                              Step {step.step}
                            </span>
                        ...
                        >
                          ...
                          <ChevronRight
                            className={`w-2.5 h-2.5 xs:w-3 xs:h-3 transition-transform ${isExpanded ? "rotate-90" : ""}`}
                          />
                        </button>
                        ...
                        {!prefersReducedMotion ? (
                            ...
                            {isExpanded && (
                              ...
                              >
                                {step.details.map((detail, i) => (
                                  <div
                                    key={i}
                                    className="flex items-center gap-1.5 xs:gap-2 text-[9px] xs:text-[10px]"
                                  >
                          ...
                          isExpanded && (
                            <div className="mt-3 xs:mt-4 pt-3 xs:pt-4 border-t border-purple-200 dark:border-purple-800 space-y-1.5 xs:space-y-2">
                              {step.details.map((detail, i) => (
                                <div
                                  key={i}
                                  className="flex items-center gap-1.5 xs:gap-2 text-[9px] xs:text-[10px]"
                ...
                return (
                  <Reveal key={idx} delay={idx * 0.1}>
                    <div className="bg-card rounded-xl border border-purple-200 dark:border-purple-800 hover:border-purple-300 transition-all p-4 xs:p-5 sm:p-6 text-center group h-full">
                      <div
                        className={`w-11 h-11 xs:w-12 xs:h-12 sm:w-14 sm:h-14 rounded-xl ${colors.bg} flex items-center justify-center mx-auto mb-2 xs:mb-3 sm:mb-4 group-hover:scale-110 transition-transform`}
                      >
                        <Icon
                          className={`w-5 h-5 xs:w-6 xs:h-6 sm:w-7 sm:h-7 ${colors.text}`}
                        />
                      </div>
                      <h3 className="font-black text-sm xs:text-base sm:text-lg mb-1 xs:mb-2">
                        {pillar.title}
                      </h3>
          ...
          <div className="mb-12 xs:mb-16 sm:mb-20">
            <div className="text-center mb-6 xs:mb-8 sm:mb-12">
              ...
              <p className="text-xs xs:text-sm sm:text-base text-muted-foreground">
                Modern tools serving an ancient tradition
              </p>
            </div>
                ...
                return (
                  <Reveal key={idx} delay={idx * 0.1}>
                    <div className="bg-card rounded-xl border border-purple-200 dark:border-purple-800 hover:border-purple-300 transition-all p-4 xs:p-5 sm:p-6 group h-full">
                      ...
                      <h3 className="font-black text-sm xs:text-base mb-0.5 xs:mb-1">
                        {tech.title}
                      </h3>
                      <p className="text-xs xs:text-sm text-muted-foreground">
                        {tech.description}
          ...
          <Reveal>
            <div className="mb-12 xs:mb-16 sm:mb-20 rounded-xl xs:rounded-2xl overflow-hidden">
              <div className="bg-gradient-to-r from-purple-600 to-amber-500 p-6 xs:p-8 sm:p-10 md:p-12 text-center">
                ...
                <h2 className="text-lg xs:text-xl sm:text-2xl md:text-3xl font-black text-white mb-1 xs:mb-2 sm:mb-3">
                  Ready to Become a Carrier?
                </h2>
                <p className="text-white/90 text-xs xs:text-sm sm:text-base mb-4 xs:mb-5 sm:mb-6 max-w-md mx-auto px-4">
                  Begin your journey with a complimentary assessment from our
                  Dean.
                </p>
                <div className="flex flex-col sm:flex-row gap-2 xs:gap-3 sm:gap-4 justify-center px-4">
                  ...
                  <Link href="/contact" className="w-full sm:w-auto">
                    <Button
                      variant="outline"
                      className="w-full rounded-full px-4 xs:px-5 sm:px-6 py-2 xs:py-2.5 sm:py-3 border-white text-white hover:bg-white/20 font-black text-[9px] xs:text-[10px] sm:text-xs md:text-sm"
                    >
                      Speak to an Advisor
                    </Button>
                  </Link>

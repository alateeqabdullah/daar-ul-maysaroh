...
const structuredData = {
  ...
  "@type": "ContactPage",
  "name": "Contact Al-Maysaroh Scholars",
  "description": "Connect directly with our scholarly council for admissions, financial aid, academic support, or technical assistance.",
  "url": "https://almaysaroh.com/contact",
  "mainEntity": {
    "@type": "Organization",
    "name": "Al-Maysaroh International Institute",
    "email": "info.almaysaroh@gmail.com",
    "telephone": "+2349110163930",
    "contactPoint": DEPARTMENTS.map(dept => ({
      "@type": "ContactPoint",
      "contactType": dept.name,
      "email": dept.email,
      "availableLanguage": ["English", "Arabic", "Urdu", "French", "Hausa"],
    })),
  },
};

...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Meet our distinguished faculty of Ijazah-certified scholars with unbroken chains of transmission.",
    type: "website",
    locale: "en_US",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Al-Maysaroh Scholars",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Our Scholars | Al-Maysaroh",
    description: "Meet our distinguished faculty of Ijazah-certified scholars.",

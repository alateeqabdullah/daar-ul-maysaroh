...
export function SectionDeclaration({
  ...
  return (
    <motion.div
      ...
      className="space-y-6"
    >
      <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-50/30 to-amber-50/30 dark:from-purple-600/10 dark:to-amber-500/10 border border-purple-200 dark:border-purple-800/30">
        <div className="flex items-start gap-3 mb-4">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-600 to-amber-500 flex items-center justify-center shrink-0 shadow-lg">
        ...
        <div className="space-y-2.5 text-sm text-muted-foreground pl-13">
          <div className="flex items-start gap-2">
            <Shield className="w-4 h-4 text-amber-500 shrink-0 mt-0.5" />
            <span>Admission is subject to assessment and approval by Daar-ul-Maysaroh.</span>
          </div>
          <div className="flex items-start gap-2">
            <Shield className="w-4 h-4 text-amber-500 shrink-0 mt-0.5" />
            <span>The student may be placed according to their Qur'ān and Islamic learning level.</span>
          </div>
          <div className="flex items-start gap-2">
            <Shield className="w-4 h-4 text-amber-500 shrink-0 mt-0.5" />
            <span>I am responsible for providing accurate information about the student's health, welfare and educational background.</span>
          </div>
          <div className="flex items-start gap-2">
            <Shield className="w-4 h-4 text-amber-500 shrink-0 mt-0.5" />
            <span>I will inform the Madrasah of any important change affecting my ward.</span>
          </div>
          <div className="flex items-start gap-2">
            <Shield className="w-4 h-4 text-amber-500 shrink-0 mt-0.5" />
            <span>I agree to abide by the rules, policies and regulations of Daar-ul-Maysaroh.</span>
          </div>
          <div className="flex items-start gap-2">
            <Shield className="w-4 h-4 text-amber-500 shrink-0 mt-0.5" />
            <span>I understand that submission of this form does not by itself constitute confirmation of admission.</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-start gap-3 p-4 rounded-xl bg-card/50 border border-border">
        <input
          ...
          checked={formData.agreeDeclaration}
          onChange={handleChange}
          className="w-5 h-5 mt-0.5 rounded border-border bg-card text-purple-600 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-background"
        />
        <label htmlFor="agreeDeclaration" className="text-sm text-foreground">
          I confirm that I have read and understood the above declaration.
          <span className="text-amber-500"> *</span>
        </label>
      </div>

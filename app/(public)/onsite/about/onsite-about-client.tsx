...
const DAILY_RHYTHM = [
  ...
  {
    time: "4:30 AM",
    activity: "Fajr & Quran Recitation",
    icon: Sun,
    color: "amber",
  },
  {
    time: "5:00 AM",
    activity: "Morning Memorization",
    icon: BookOpen,
    color: "purple",
  },
  {
  ...
  {
    time: "9:00 AM",
    activity: "Tajweed & Recitation",
    icon: BookOpen,
    color: "purple",
  },
  {
    time: "12:00 PM",
    activity: "Dhuhr & Lunch",
    icon: Utensils,
    color: "amber",
  },
  {
    time: "2:00 PM",
    activity: "Revision & Muraja'ah",
    icon: Crown,
    color: "purple",
  },
  {
    time: "4:30 PM",
    activity: "Afternoon Memorization",
    icon: BookOpen,
    color: "amber",
  },
  {
    time: "6:30 PM",
    activity: "Maghrib & Dinner",
    icon: Utensils,
    color: "purple",
  },
  {
    time: "8:00 PM",
    activity: "Isha & Night Review",
    icon: Moon,
    color: "amber",
  },

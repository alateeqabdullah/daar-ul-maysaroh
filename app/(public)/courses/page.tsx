...
export const metadata: Metadata = {
  title: "Quran Courses | Al-Maysaroh International Institute",
  description: "Explore our comprehensive Quran courses including Hifz, Tajweed, Arabic, Tafsir, and children's programs. All courses include Ijazah certification and authentic Sanad chains.",
  keywords: ["Quran courses online, Hifz program, Tajweed classes, Quranic Arabic, Tafsir course, children Quran learning, Ijazah certification, Sanad",
       "Quran courses",
       "Quranic courses",
       "Quran classes",
       "Quranic teaching",
       ...
       "Sanad",
        ...
        "Quranic courses with Ijazah",
        "Sanad-based Quran courses",
        "Quranic courses with certification",
        "Quranic courses with authentic teachers",
        "Quranic courses with scholarly tradition",
        "Quranic courses for all levels",
        "Quranic courses for beginners",
        "Quranic courses for advanced learners",
        "Quranic courses for children",
        "Quranic courses for adults",
        "Quranic courses with flexible scheduling",
        "Quranic courses with personalized instruction",
        "Quranic courses with progress tracking",
        "Quranic courses with community support",
        "Quranic courses with live correction",
        "Quranic courses with audio analysis",
        "Quranic courses with thematic studies",
        "Quranic courses with scholarly mentorship",
        "Quranic courses with research paper",
        "Quranic courses with interactive games",
        "Quranic courses with reward system",
        "Quranic courses with parent portal",
        "Quranic courses with weekly updates",
        "Quranic courses with progress badges",
        "Quranic courses with certificate",
        "Quranic courses with Ijazah certification",
        "Quranic courses with Sanad chain",
       "Quranic courses with expert teachers",
       "Quranic courses with personalized feedback",
       "Quranic courses with flexible formats",
       "Quranic courses with group sessions",
       "Quranic courses with 1-on-1 instruction",
       "Quranic courses with live sessions",
       "Quranic courses with recorded sessions",
       "Quranic courses with interactive content",
       "Quranic courses with community forums",
       "Quranic courses with mentorship programs",
       "Quranic courses with scholarship opportunities",
       "Quranic courses with financial aid",
       "Quranic courses with free trials",
       "Quranic courses with money-back guarantee",
       "Quranic courses with high ratings",
        "Quranic courses with positive reviews",
        "Quranic courses with satisfied students",
       "Quranic courses with proven results",
       "Quranic courses with success stories",
       "Quranic courses with testimonials",
       "Quranic courses with case studies",
       "Quranic courses with research-backed methods",
       "Quranic courses with evidence-based curriculum",
       "Quranic courses with scholarly endorsement",
       "Quranic courses with community recognition",
       "Quranic courses with industry partnerships",
       "Quranic courses with academic collaborations",
       "Quranic courses with institutional support",
       "Quranic courses with global reach",
       "Quranic courses with cultural relevance",
       "Quranic courses with spiritual depth",
       "Quranic courses with intellectual rigor",
       "Quranic courses with practical application",
       "Quranic courses with transformative impact"

     ],
  authors: [{ name: "Al-Maysaroh Institute" }],
  openGraph: {
    title: "Choose Your Path - Quran Courses | Al-Maysaroh",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Al-Maysaroh Quran Courses",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Quran Courses | Al-Maysaroh",
    description: "Explore our comprehensive Quran courses with Ijazah certification.",

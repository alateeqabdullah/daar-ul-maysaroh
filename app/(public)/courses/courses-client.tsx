...
const COURSES = [
  ...
  },
  {
    ...
    tagline: "Fluent Recitation",
    description:
      "Learn to read the Quran fluently with proper Tajweed rules. Perfect for beginners and those seeking to improve their recitation.",
  ...
  {
    id: "muroja'ah",
    name: "Muroja'ah Al-Quran",
    tagline: "Memorization Maintenance",
    description:
      "Maintain and strengthen your Quran memorization with regular revision sessions and personalized feedback.",
    duration: "Ongoing",
    format: "1-on-1",
    students: "100+",
    icon: CheckCircle2,
  ...
  },
  {
    ...
    description: " Memorize the last Juz of the Quran with proper Tajweed. Designed for beginners to build a strong foundation in Quranic memorization.",
    duration: "6-12 months",
    format: "Group",
    students: "80+",
    icon: Star,
  ...
  },
  {
    id: "juz-tabarak",
    name: "Juz Tabarak",
    tagline: "Advanced Memorization",
    description:
      "Memorize Juz Tabarak with proper Tajweed and understanding. Ideal for those who have completed Juz Amma and want to continue their memorization journey.",
    duration: "6-12 months",
    format: "Group",
    students: "50+",
    icon: Star,
  ...
  },
  {
    id: "group-tajweed",
    name: "Group Tajweed",
    tagline: "Group Recitation Mastery",
    description:
      "Learn the rules of Tajweed in a fun, interactive group setting. Perfect for children ages 7-12 to improve their Quranic recitation together.",
    duration: "6-9 months",
    format: "Group (4-10)",
    students: "80+",
    icon: Mic,

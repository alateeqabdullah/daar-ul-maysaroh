...
const TEACHERS_DATA: Record<string, any> = {
  "abubakar-abdurrozzaaq-al-maysari": {
    ...
    fullBio:
      "With over 25 years of teaching experience, Shaykh Abubakar holds ijazah in all ten Qira'at with an unbroken chain reaching back to Prophet Muhammad (ﷺ). He has trained over 200 certified Qurra worldwide and serves on multiple international scholarly councils.",

...
//   return (
//     <main className="pt-20 xs:pt-24 sm:pt-28 md:pt-32 lg:pt-36 pb-16 xs:pb-20 sm:pb-24 md:pb-28 lg:pb-32 bg-background relative overflow-hidden">
...
//       {/* Celestial Orbs - Updated colors */}
//       <div className="absolute top-1/4 -left-20 w-80 xs:w-96 h-80 xs:h-96 bg-purple-600/10 rounded-full blur-3xl" />
//       <div className="absolute bottom-1/4 -right-20 w-80 xs:w-96 h-80 xs:h-96 bg-amber-500/10 rounded-full blur-3xl" />
...
//           }}
//         >
//           <Star className="w-2 h-2 xs:w-3 xs:h-3 text-amber-500 fill-amber-500/20" />
//         </div>
//       ))}
...
//                         rows={5}
//                         required
//                         className="w-full p-3 xs:p-4 rounded-lg bg-background border-2 border-border focus:border-purple-500 outline-none text-sm transition-all resize-none"
...
//                     <p className="text-[9px] xs:text-[10px] text-center text-muted-foreground">
...
export default function ContactHub() {
  ...
  return (
    <main className="pt-20 xs:pt-24 sm:pt-28 md:pt-32 lg:pt-36 pb-16 xs:pb-20 sm:pb-24 md:pb-28 lg:pb-32 bg-gradient-to-b from-background via-purple-50/5 to-amber-50/5 relative overflow-hidden">
      {/* Islamic Pattern Background */}
      <div

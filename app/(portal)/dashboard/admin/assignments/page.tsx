...
import { auth } from "@/lib/auth";
import { redirect } from "next/navigation";
import AssignmentTerminalClient from "@/components/admin/assignment-terminal-client";
...
export default async function AssignmentsPage() {
  ...
  const [assignmentsRaw, subjects] = await Promise.all([
    prisma.assignment.findMany({
      include: {
  ...
  // Next.js 16 Serialization Handshake

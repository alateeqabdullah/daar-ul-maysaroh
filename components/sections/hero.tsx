    ...
    >
      ...
      <div className="container mx-auto px-4 xs:px-5 sm:px-6 lg:grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 lg:gap-16 xl:gap-24 items-center relative z-10">
        ...
        <motion.div
          ...
          className="relative h-[350px] xs:h-[400px] sm:h-[450px] md:h-[500px] lg:h-[600px] xl:h-[700px] flex items-center justify-center order-1 lg:order-2 mb-6 xs:mb-8 lg:mb-0"
        >
          {/* Simplified orbit for desktop */}
          {shouldAnimate && (
            <motion.div
              animate={{ rotate: 360 }}
              transition={{ duration: 50, repeat: Infinity, ease: "linear" }}
          ...
          <div className="bg-card w-full max-w-[85vw] xs:max-w-[400px] sm:max-w-[450px] md:max-w-[500px] lg:max-w-[550px] xl:max-w-[600px] rounded-2xl xs:rounded-3xl sm:rounded-3xl md:rounded-[3rem] lg:rounded-[4rem] border border-purple-200 dark:border-purple-800 p-5 xs:p-6 sm:p-7 md:p-10 lg:p-12 xl:p-16 shadow-xl text-center relative overflow-hidden group bg-gradient-to-br from-background to-purple-50/10">
            {/* Inner glow */}
            <div className="absolute -top-10 -left-10 md:-top-20 md:-left-20 w-32 h-32 md:w-48 md:h-48 lg:w-64 lg:h-64 bg-purple-600/5 md:bg-purple-600/10 blur-[60px] md:blur-[80px] lg:blur-[100px] rounded-full group-hover:bg-purple-600/10 md:group-hover:bg-purple-600/20 transition-all duration-1000" />
            ...
            <motion.div
              ...
              className="relative z-10"
            >
              <div className="quran-monumental text-xl xs:text-2xl sm:text-2xl md:text-3xl lg:text-4xl mb-4 xs:mb-5 sm:mb-6 md:mb-8 lg:mb-12 selection:bg-amber-500/40 cursor-default leading-relaxed text-purple-900 dark:text-purple-100">
                وَلَقَدْ يَسَّرْنَا الْقُرْآنَ لِلذِّكْرِ
              </div>

              <div className="space-y-4 xs:space-y-5 sm:space-y-5 md:space-y-6 lg:space-y-10">
                <p className="text-base xs:text-lg sm:text-xl md:text-2xl lg:text-3xl font-heading italic text-foreground/90 leading-[1.4] px-2">
                  <span className="sr-only">Quranic verse meaning: </span>
                  {`"Verily, We have made this Quran `}
                  <span className="text-purple-600 not-italic font-black">
                    {`easy for remembrance.`}
                  </span>
                  {`"`}
                </p>

                <div className="flex items-center justify-center gap-2 xs:gap-3 sm:gap-4 md:gap-6 lg:gap-8">
                  <div className="h-px md:h-0.5 flex-1 bg-gradient-to-r from-transparent via-amber-500/30 to-amber-500" />
                  <div className="flex flex-col items-center min-w-[80px] xs:min-w-[90px] sm:min-w-[100px]">
                    <BookMarked className="w-3.5 h-3.5 xs:w-4 xs:h-4 sm:w-4.5 sm:h-4.5 md:w-5 md:h-5 text-amber-500 mb-1 md:mb-2" />
                    <p className="text-[8px] xs:text-[9px] sm:text-[9px] md:text-[10px] lg:text-[10px] font-black text-amber-500 uppercase tracking-[0.2em] sm:tracking-[0.3em] md:tracking-[0.4em] lg:tracking-[0.6em] whitespace-nowrap">
                      Surah Al-Qamar
                    </p>
                  </div>
                  <div className="h-px md:h-0.5 flex-1 bg-gradient-to-l from-transparent via-amber-500/30 to-amber-500" />
                </div>
              </div>
            </motion.div>

            {/* STATS */}
            <div className="mt-6 xs:mt-7 sm:mt-8 md:mt-10 lg:mt-16 grid grid-cols-2 gap-3 xs:gap-4 sm:gap-5 md:gap-6 lg:gap-8 border-t border-border/30 pt-4 xs:pt-5 sm:pt-6 md:pt-8 lg:pt-10">
              <div className="space-y-0.5 xs:space-y-1">
                <div className="text-2xl xs:text-3xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-purple-600 tracking-tighter tabular-nums">
                  1400+
                </div>
                <div className="text-[8px] xs:text-[9px] sm:text-[9px] md:text-[10px] font-black uppercase tracking-[0.15em] xs:tracking-[0.2em] md:tracking-[0.3em] text-muted-foreground">
                  Years of Sanad
                </div>
              </div>
              <div className="space-y-0.5 xs:space-y-1">
            ...
            <div className="absolute bottom-3 xs:bottom-4 sm:bottom-4 md:bottom-6 lg:bottom-8 left-1/2 -translate-x-1/2">
              <div className="flex items-center gap-1.5 xs:gap-2 px-2.5 xs:px-3 sm:px-3 md:px-4 py-1 xs:py-1.5 sm:py-1.5 md:py-2 rounded-full bg-white/5 dark:bg-black/20 border border-purple-200 dark:border-purple-800 backdrop-blur-sm">
                <ShieldCheck className="w-2.5 h-2.5 xs:w-3 xs:h-3 sm:w-3 sm:h-3 md:w-3.5 md:h-3.5 lg:w-4 lg:h-4 text-emerald-500" />
                <span className="text-[6px] xs:text-[7px] sm:text-[7px] md:text-[8px] lg:text-[9px] font-black tracking-wider uppercase">
                  Authentic Sanad
                </span>
              </div>
            </div>

      ...
      <div className="container mx-auto px-4 xs:px-5 sm:px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 xs:gap-10 sm:gap-12 lg:gap-16 xl:gap-20 items-start">
          ...
          <div className="space-y-6 xs:space-y-8 sm:space-y-10 md:space-y-12">
            ...
            <div className="grid xs:grid-cols-2 gap-3 xs:gap-4 sm:gap-5 md:gap-6">
              <Reveal delay={0.2}>
                <div className="p-4 xs:p-5 sm:p-6 md:p-7 lg:p-8 rounded-xl xs:rounded-2xl border-2 border-purple-100 dark:border-purple-900/30 hover:border-purple-400 dark:hover:border-purple-600 transition-all group bg-linear-to-br from-background to-purple-50/20">
              ...
              <Reveal delay={0.3}>
                <div className="p-4 xs:p-5 sm:p-6 md:p-7 lg:p-8 rounded-xl xs:rounded-2xl border-2 border-amber-200 dark:border-amber-900/30 hover:border-amber-400 dark:hover:border-amber-500 transition-all group bg-linear-to-br from-background to-amber-50/20">
              ...
              <div className="flex flex-col xs:flex-row items-start xs:items-center gap-3 xs:gap-4 sm:gap-5 md:gap-6 pt-4 xs:pt-5 sm:pt-6 border-t border-border/50">
                <div className="flex -space-x-2 xs:-space-x-3">
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className="w-8 h-8 xs:w-9 xs:h-9 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full border-2 border-background bg-linear-to-br from-purple-600 to-purple-700 shadow-xl"
                    />
                  ))}
                </div>
                <div>
            ...
            <div className="bg-card p-5 xs:p-6 sm:p-7 md:p-8 lg:p-10 xl:p-12 rounded-2xl xs:rounded-3xl border border-purple-200 dark:border-purple-800 shadow-xl relative overflow-hidden">
              ...
              {isSuccess && (
                <div className="absolute inset-0 bg-background/95 backdrop-blur-sm z-20 flex items-center justify-center animate-in fade-in duration-300 rounded-2xl xs:rounded-3xl">
                  <div className="bg-linear-to-br from-purple-50 to-background dark:from-purple-950/30 dark:to-background p-6 xs:p-8 rounded-2xl text-center max-w-xs mx-4 shadow-2xl border border-purple-200 dark:border-purple-800">
              ...
              <h3 className="text-lg xs:text-xl sm:text-2xl font-black uppercase tracking-tighter mb-4 xs:mb-5 sm:mb-6 md:mb-8 bg-linear-to-r from-purple-600 to-amber-600 bg-clip-text text-transparent">
                Official Inquiry
              </h3>

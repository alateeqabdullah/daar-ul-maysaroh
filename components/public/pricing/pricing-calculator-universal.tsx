...
// Muroja'ah-specific pricing configuration
const MUROJAAH_PRICING_CONFIG = {
  subjects: [
    {
      id: "murojaah",
      name: "Muroja'ah (Revision)",
      baseFactor: 0.28,
      icon: RefreshCw,
      description: "Preserve and perfect your memorization",
    },
  ],
  durations: [45, 60, 75],
  frequencies: [2, 3, 4],
  basePricePerMinute: 0.26,
};

export function PricingCalculatorMurojaah({ dbPlans }: { dbPlans?: any[] }) {
  const [selection, setSelection] = useState({
    subject: "murojaah",
    duration: 60,
    frequency: 3,
  ...
  useEffect(() => {
    const subject = MUROJAAH_PRICING_CONFIG.subjects.find(
      (s) => s.id === selection.subject
    );
    const monthlySessions = selection.frequency * 4;
    const pricePerSession =
      selection.duration * MUROJAAH_PRICING_CONFIG.basePricePerMinute;
    const rawPrice =
      pricePerSession * monthlySessions * (subject?.baseFactor || 1);
    setTotalPrice(Math.round(rawPrice));
  }, [selection]);

  const currentSubject = MUROJAAH_PRICING_CONFIG.subjects.find(
    (s) => s.id === selection.subject
  );
  const monthlySessions = selection.frequency * 4;
  const pricePerLesson = totalPrice / monthlySessions;
      ...
      <div className="institutional-card overflow-hidden bg-gradient-to-br from-background to-muted/5 shadow-2xl">
        <div className="grid lg:grid-cols-5">
          <div className="lg:col-span-3 p-6 sm:p-8 md:p-10 space-y-8 border-r border-border/50">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-rose-700/10 flex items-center justify-center">
                  <Calculator className="w-5 h-5 text-rose-700" />
                </div>
                <div>
                  <h3 className="text-lg sm:text-xl font-black uppercase tracking-tighter">
                    Muroja'ah Tuition Calculator
                  </h3>
                  <p className="text-xs text-muted-foreground">
                    Customize your revision journey
                  </p>
                </div>
              </div>
              <Sparkles className="w-5 h-5 text-rose-700/50" />
            </div>

            {/* Subject Selection - Fixed for Muroja'ah */}
            <div className="space-y-4">
              <label className="text-[11px] font-black uppercase tracking-widest text-rose-700">
                Select Discipline
              </label>
              <div className="grid grid-cols-1 gap-3">
                {MUROJAAH_PRICING_CONFIG.subjects.map((s) => (
                  <button
                    key={s.id}
                    className="group relative p-4 rounded-xl border-2 border-rose-700 bg-rose-700/5 shadow-md cursor-default"
                  >
                    <div className="flex items-start gap-3">
                      <div className="w-8 h-8 rounded-lg bg-rose-700 text-white flex items-center justify-center">
                        <s.icon className="w-4 h-4" />
                      </div>
                      <div className="flex-1">
                        <p className="font-black text-sm uppercase tracking-tight text-rose-700">
                          {s.name}
                        </p>
                        <p className="text-[10px] text-muted-foreground mt-0.5">
                          {s.description}
            ...
            {/* Duration Selection */}
            <div className="space-y-4">
              <label className="text-[11px] font-black uppercase tracking-widest text-rose-700 flex items-center gap-2">
                <Clock className="w-3 h-3" /> Session Duration
              </label>
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {MUROJAAH_PRICING_CONFIG.durations.map((d) => (
                  <button
                    key={d}
                    onClick={() => setSelection({ ...selection, duration: d })}
                    className={cn(
                      ...
                      selection.duration === d
                        ...
                        : "border-border hover:border-rose-700/30 hover:bg-rose-50/50"
                    )}
                  >
                    {d} min
                  </button>
            ...
            {/* Frequency Selection - More intensive for revision */}
            <div className="space-y-4">
              <label className="text-[11px] font-black uppercase tracking-widest text-rose-700 flex items-center gap-2">
                <Calendar className="w-3 h-3" /> Sessions per Week
              </label>
              <div className="grid grid-cols-3 gap-2 sm:gap-3">
                {MUROJAAH_PRICING_CONFIG.frequencies.map((f) => (
                  <button
                    key={f}
                    onClick={() => setSelection({ ...selection, frequency: f })}
                    className={cn(
            ...
            <div className="pt-4 border-t border-border/50">
              <p className="text-[10px] text-muted-foreground flex items-center gap-2">
                <Info className="w-3 h-3" />
                Based on {selection.frequency}x weekly • {monthlySessions} revision sessions/month
              </p>
            </div>
          </div>

          {/* Summary Panel */}
          <div className="lg:col-span-2 p-6 sm:p-8 md:p-10 bg-gradient-to-br from-rose-700/5 to-pink-700/5 flex flex-col justify-between">
            <div className="space-y-8">
              <div className="text-center space-y-3">
                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-rose-700">
                  Estimated Monthly Tuition
                </p>
                <AnimatePresence mode="wait">
                  <motion.div
                  ...
                  >
                    ...
                    <div className="absolute -top-2 -right-2 sm:-right-4">
                      <DollarSign className="w-5 h-5 text-rose-700/30" />
                    </div>
                  </motion.div>
                </AnimatePresence>
                <p className="text-xs text-muted-foreground">per month • flexible billing</p>
              ...
              <div className="space-y-4 bg-background/50 p-5 sm:p-6 rounded-2xl border border-border/50 shadow-sm">
                <div className="flex justify-between items-center py-2 border-b border-border/30">
                  ...
                  <span className="text-lg font-black">{monthlySessions} sessions</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-border/30">
                  <span className="text-xs font-black uppercase tracking-wider text-muted-foreground">
                    Per Session Rate
                ...
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="text-lg font-black">
                    ${MUROJAAH_PRICING_CONFIG.basePricePerMinute.toFixed(2)}
                  </span>
                </div>
              </div>

              <div className="p-4 rounded-xl bg-rose-700/5 border border-rose-700/10">
                <div className="flex items-center gap-2 mb-2">
            ...
            <div className="mt-8 space-y-3">
              <Link href="/register" className="block">
                <Button
                  className="w-full h-14 sm:h-16 rounded-xl font-black text-sm tracking-widest uppercase shadow-xl group relative overflow-hidden bg-rose-700 hover:bg-rose-800"
                  onMouseEnter={() => setIsHovered(true)}
                  onMouseLeave={() => setIsHovered(false)}
                >
                  <span className="relative z-10 flex items-center justify-center gap-2">
              ...
              <p className="text-[10px] text-center text-muted-foreground flex items-center justify-center gap-1">
                <Info className="w-3 h-3" />
                Final price may vary based on teacher assignment and revision needs
              </p>
            </div>
          </div>
        </div>
...
// Juz Tabarak pricing configuration
const JUZ_TABARAK_PRICING_CONFIG = {
  subjects: [
    {
      id: "juz-tabarak",
      name: "Juz Tabarak",
      baseFactor: 0.26,
      icon: Star,
      description: "Memorize the 29th Juz with group support",
    },
  ],
  durations: [45, 60],
  frequencies: [2],
  basePricePerMinute: 0.24,
};

export function PricingCalculatorJuzTabarak({ dbPlans }: { dbPlans?: any[] }) {
  const [selection, setSelection] = useState({
    subject: "juz-tabarak",
    duration: 60,
    frequency: 2,
  ...
  useEffect(() => {
    const subject = JUZ_TABARAK_PRICING_CONFIG.subjects.find(
      (s) => s.id === selection.subject
    );
    const monthlySessions = selection.frequency * 4;
    const pricePerSession =
      selection.duration * JUZ_TABARAK_PRICING_CONFIG.basePricePerMinute;
    const rawPrice =
      pricePerSession * monthlySessions * (subject?.baseFactor || 1);
    setTotalPrice(Math.round(rawPrice));
  }, [selection]);

  const currentSubject = JUZ_TABARAK_PRICING_CONFIG.subjects.find(
    (s) => s.id === selection.subject
  );
  const monthlySessions = selection.frequency * 4;
  const pricePerLesson = totalPrice / monthlySessions;
          ...
          <div className="lg:col-span-3 p-6 sm:p-8 md:p-10 space-y-8 border-r border-border/50">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-black uppercase tracking-tighter">
                    Juz Tabarak Tuition Calculator
                  </h3>
                  <p className="text-xs text-muted-foreground">
            ...
            {/* Subject Selection - Fixed for Juz Tabarak */}
            <div className="space-y-4">
              <label className="text-[11px] font-black uppercase tracking-widest text-purple-700">
                Select Program
              </label>
              <div className="grid grid-cols-1 gap-3">
                {JUZ_TABARAK_PRICING_CONFIG.subjects.map((s) => (
                  <button
                    key={s.id}
                    className="group relative p-4 rounded-xl border-2 border-purple-700 bg-purple-700/5 shadow-md cursor-default"
                  >
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                {JUZ_TABARAK_PRICING_CONFIG.durations.map((d) => (
                  <button
                    key={d}
                    onClick={() => setSelection({ ...selection, duration: d })}
                    className={cn(
            ...
            {/* Frequency - Fixed for group program */}
            <div className="space-y-4">
              <label className="text-[11px] font-black uppercase tracking-widest text-purple-700 flex items-center gap-2">
                <Calendar className="w-3 h-3" /> Sessions per Week
              </label>
              <div className="text-center p-3 rounded-xl bg-purple-50/50 border border-purple-200">
                <span className="font-black">2 sessions per week</span>
                <p className="text-[10px] text-muted-foreground mt-1">Standard group program schedule</p>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-border/50">
              <p className="text-[10px] text-muted-foreground flex items-center gap-2">
                <Info className="w-3 h-3" />
                Based on 2x weekly • {monthlySessions} sessions/month
              </p>
            </div>
          </div>

          {/* Summary Panel */}
          <div className="lg:col-span-2 p-6 sm:p-8 md:p-10 bg-gradient-to-br from-purple-700/5 to-indigo-700/5 flex flex-col justify-between">
            <div className="space-y-8">
              <div className="text-center space-y-3">
                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-purple-700">
                  Estimated Monthly Tuition
                ...
                <p className="text-xs text-muted-foreground">per month • group pricing</p>
              </div>
              ...
              <div className="space-y-4 bg-background/50 p-5 sm:p-6 rounded-2xl border border-border/50 shadow-sm">
                ...
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="text-lg font-black">4-6 students</span>
                </div>
              </div>
              ...
              <div className="p-4 rounded-xl bg-purple-700/5 border border-purple-700/10">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  ...
                  <div>
                    <span className="text-muted-foreground text-xs">Weekly:</span>
                    <p className="font-black">2 sessions</p>
                  </div>
                  <div>
                    <span className="text-muted-foreground text-xs">Format:</span>
                    <p className="font-black">Small Group</p>
                  </div>
                </div>
              </div>
            </div>
...
// Group Tajweed pricing configuration
const GROUP_TAJWEED_PRICING_CONFIG = {
  subjects: [
    {
      id: "group-tajweed",
      name: "Group Tajweed",
      baseFactor: 0.24,
      icon: Mic,
      description: "Learn Tajweed rules in a group setting",
    },
  ],
  durations: [45, 60],
  frequencies: [2],
...
export function PricingCalculatorGroupTajweed({ dbPlans }: { dbPlans?: any[] }) {
  const [selection, setSelection] = useState({
    subject: "group-tajweed",
    duration: 60,
    frequency: 2,
  });
  const [totalPrice, setTotalPrice] = useState(0);
  ...
  useEffect(() => {
    const subject = GROUP_TAJWEED_PRICING_CONFIG.subjects.find(
      (s) => s.id === selection.subject
    );
    const monthlySessions = selection.frequency * 4;
    const pricePerSession =
      selection.duration * GROUP_TAJWEED_PRICING_CONFIG.basePricePerMinute;
    const rawPrice =
      pricePerSession * monthlySessions * (subject?.baseFactor || 1);
    setTotalPrice(Math.round(rawPrice));
  }, [selection]);

  const currentSubject = GROUP_TAJWEED_PRICING_CONFIG.subjects.find(
    (s) => s.id === selection.subject
  );
  const monthlySessions = selection.frequency * 4;
  const pricePerLesson = totalPrice / monthlySessions;
    ...
    <div className="w-full max-w-6xl mx-auto">
      <div className="institutional-card overflow-hidden bg-gradient-to-br from-background to-muted/5 shadow-2xl">
        <div className="grid lg:grid-cols-5">
          <div className="lg:col-span-3 p-6 sm:p-8 md:p-10 space-y-8 border-r border-border/50">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-black uppercase tracking-tighter">
                    Group Tajweed Tuition Calculator
                  </h3>
                  <p className="text-xs text-muted-foreground">
                    Group program pricing
                  </p>
            ...
            {/* Subject Selection - Fixed for Group Tajweed */}
            <div className="space-y-4">
              <label className="text-[11px] font-black uppercase tracking-widest text-teal-700">
                Select Program
              </label>
              <div className="grid grid-cols-1 gap-3">
                {GROUP_TAJWEED_PRICING_CONFIG.subjects.map((s) => (
                  <button
                    key={s.id}
                    className="group relative p-4 rounded-xl border-2 border-teal-700 bg-teal-700/5 shadow-md cursor-default"
                  >
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                {GROUP_TAJWEED_PRICING_CONFIG.durations.map((d) => (
                  <button
                    key={d}
                    onClick={() => setSelection({ ...selection, duration: d })}
                    className={cn(
            ...
            <div className="space-y-4">
              ...
              <div className="text-center p-3 rounded-xl bg-teal-50/50 border border-teal-200">
                <span className="font-black">2 sessions per week</span>
                <p className="text-[10px] text-muted-foreground mt-1">Standard group program schedule</p>
              </div>
            </div>
          ...
          {/* Summary Panel */}
          <div className="lg:col-span-2 p-6 sm:p-8 md:p-10 bg-gradient-to-br from-teal-700/5 to-cyan-700/5 flex flex-col justify-between">
            <div className="space-y-8">
              <div className="text-center space-y-3">
                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-teal-700">
                  Estimated Monthly Tuition

        ...
        <div className="grid lg:grid-cols-5">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <p
                          className={cn(
                            "font-black text-sm uppercase tracking-tight",
                            selection.subject === s.id ? "text-purple-600" : "",
                          )}
                        >
                          {s.name}
                        </p>
          ...
          <div className="lg:col-span-2 p-6 sm:p-8 md:p-10 bg-linear-to-br from-purple-600/5 to-amber-500/5 flex flex-col justify-between">
            ...
            <div className="mt-8 space-y-3">
              <Link href="/register" className="block">
                <Button
                  className="w-full h-14 sm:h-16 rounded-xl font-black text-sm tracking-widest uppercase shadow-xl group relative overflow-hidden bg-purple-600 hover:bg-purple-700"
                  onMouseEnter={() => setIsHovered(true)}
                  onMouseLeave={() => setIsHovered(false)}
                >
                  <span className="relative z-10 flex items-center justify-center gap-2">

...
export default function TeacherScheduleClient({
  ...
  const [schedules, setSchedules] =
    useState<TeacherScheduleItem[]>(initialSchedules);
    ...
    >
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button
            className="bg-gradient-to-r from-indigo-600 to-violet-600 text-white shadow-md hover:scale-105 transition-all gap-2"
      ...
      <div className="flex items-center gap-3 overflow-x-auto pb-2 scrollbar-hide">
        {days.map((day, index) => (
          ...
          >
            {day}
            {schedules.some((s) => s.dayOfWeek === index) && (
              <span
                className={cn(
              ...
              {dailySchedules.map((s) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={cn(
                        "hidden md:block absolute left-[29px] top-8 w-4 h-4 rounded-full border-4 border-white dark:border-slate-950 z-10 transition-colors",
                        active
                      ...
                      <CardContent className="p-6 flex flex-col md:flex-row gap-6 items-start md:items-center">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="text-xs font-mono text-slate-400 border px-1.5 py-0.5 rounded">
                              {s.classCode}
                            </span>
                          </div>
                          ...
                          <p className="text-sm text-slate-500 flex items-center gap-2">
                            <Layers className="h-3 w-3" /> {s.classLevel}{" "}
                        ...
                        <div className="flex flex-col items-end gap-3 min-w-[140px]">
                          ...
                          <div className="flex gap-2">
                            {s.isLive && (
                              ...
                              >
                                <MonitorPlay className="h-4 w-4 mr-2" /> Start
                              </Button>
                            )}
                            <Button
                              size="icon"
